...
model = BertModel.from_pretrained(r"E:\models\bert-base-chinese", return_dict=False)
n = 2                       # 输入最大句子个数
vocab = 21128               # 词表数目
...
# self_attention_out参数 其中 embedding_size * embedding_size + embedding_size是self输出的线性层参数，embedding_size + embedding_size是layer_norm层参数
